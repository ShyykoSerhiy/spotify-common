...
var getApi = function (spotifyAuthServer, token, refreshToken, onTokenRefreshed) {
                    ...
                    get: function (options) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    opt = __assign({ fields: 'items(track(id,name,uri,album(id,name),artists(id,name))),limit,offset,total', limit: 100, offset: 0 }, options);
                                    return [4 /*yield*/, makeRequest(queryParamsHelper("me/tracks/contains", opt), __assign(__assign({}, exports.GET), headers))];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        });
                    }); }
